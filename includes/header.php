    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-4 text-end">
                <!-- Cuadro de registro -->
                <a href="registro.php" class="btn btn-light btn-sm mx-2" style="border: 1px solid #ddd; border-radius: 4px; color: #333; text-transform: uppercase;">
                    <i class="bi bi-person-plus"></i> Registrarse
                </a>
                <!-- Cuadro de inicio de sesión -->
                <a href="login.php" class="btn btn-light btn-sm mx-2" style="border: 1px solid #ddd; border-radius: 4px; color: #333; text-transform: uppercase;">
